...
@WebServlet("/board/SummerNoteFileUpload.do")
public class SummerNoteFileUploadController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		String uploadPath = "/member_and_board_model2/"+savePath+"/"+fileRealName;
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/board/summernote_file_upload.jsp");
