...
<%@ include file="./include/header.jsp" %>
    <main>
      <div class="container">
      	...
      	<div id=contents>
      		<form method="post" action="update_process.jsp" id="join" class="form">
      			<table>
      				<colgroup>
      					<col style="width:20%">
      					<col style="width:80%">
      				...
      				<tbody>
      					<tr>
      						...
      						<td><input type="text" name="user_id" id="user_id" value="<%= loggedId %>" readonly></td>
      						<!-- <td><input type="text" name="user_id" id="user_id" value="${sessionScope.id }" readonly></td>  -->
      						<!-- disable:값이 날아가지 않음, readonly : 읽기전용 -->
      					</tr>
      					<tr>
      					...
      					<tr>
      						...
      						<td><input type="text" name="user_name" id="user_name" value="${sessionScope.name}"></td>
      					</tr>
      					<tr>
